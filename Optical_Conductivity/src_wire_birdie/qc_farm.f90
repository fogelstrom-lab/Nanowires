...
!
      if(icmptyp == 2) then
         if(abs(srate(1)).gt. 1e-14) then
             ...
             uimpP(:,ioshift) = uimpP(:,ioshift)/srate(1)
          endif
...
!
      ...
      enddo
!
!-- Temporary fix of the "edge-step-effect"
!
!     gr_1(sx,1) = gr_1(sx-1,1)
!     gr_2( 1,1) = gr_2(   2,1)
!     gr_1( 1,2) = gr_1(   2,2)
!     gr_2(sx,2) = gr_2(sx-1,2)
!
!--------------------------------------------------------------------
!
...
!     gr_1p(sx,iep) = gr_1(sx-1,1)
!     gr_2p( 1,iep) = gr_2(   2,1)

!     gr_1m( 1,iep) = gr_1(   2,2)
!     gr_2m(sx,iep) = gr_2(sx-1,2)
!
!
